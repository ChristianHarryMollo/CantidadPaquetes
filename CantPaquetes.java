public class CantPaquetes
{
	public static void main(String[] args) {
		...
		CantPaquetes pro1 = new CantPaquetes(12, new int[]{1,2,5});
		CantPaquetes pro2 = new CantPaquetes(10, new int[]{1,3,4});
		CantPaquetes pro3 = new CantPaquetes(6, new int[]{1,3,4});
		CantPaquetes pro4 = new CantPaquetes(18, new int[]{1,3,5,7});
		CantPaquetes pro5 = new CantPaquetes(360, new int[]{1,2,3,4,5,6,7,8,9});
		CantPaquetes pro6 = new CantPaquetes(360, new int[]{1,2,5,7,11,13});
		CantPaquetes pro7 = new CantPaquetes(1360, new int[]{1,2,5,7,11,13});
